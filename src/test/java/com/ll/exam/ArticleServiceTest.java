...
public class ArticleServiceTest {
    ...
    private void makeArticleTestData() {
        IntStream.rangeClosed(1, TEST_DATA_SIZE).forEach(no -> {
            boolean isBlind = no >= 11 && no <= 20; // 11번글부터 20번 글까지 블라인드
    ...
    @Test
    public void _10번글_다음글은_21번글_11번글에서_20번글까지_블라인드(){
        ArticleDto id21ArticleDto = articleService.getNextArticle(10);
        assertThat(id21ArticleDto.getId()).isEqualTo(21);
    }
}